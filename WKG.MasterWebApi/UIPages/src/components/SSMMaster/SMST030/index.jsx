...
import SMST030VM from './SMST030VM';
import * as cntrl from '../../../wkl-components';

export default class SMST030 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST030VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
        ...
        return (<form>
            <div className="col-md-12">
                <div className="mb-2">
                    ...
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox disabled={dataModel.IsEdit} mandatory={true} name="SSM_Id_F" allowClear={true} ref={(el) => this.onRefChange(el, 'SSM_Id_F')} value={dataModel.SSM_Id_F} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
                ...
                <div className="mb-2">
                    ...
                    <div className="form-control border-0 ps-0">
                        <div className="form-check  form-check-inline">
                            <input type="radio" className="form-check-input" id="hard_refresh_F" radioGroup="SMST030_Refresh_Type_F" name="Refresh_Type_F" checked={dataModel.Refresh_Type_F === 1} onChange={this.onRadioChangeF} value="hr" />
                        ...
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="emergency_refresh_F" radioGroup="SMST030_act_inact_F" name="Refresh_Type_F" checked={dataModel.Refresh_Type_F === 2} onChange={this.onRadioChangeF} value="er" />
                            <label className="form-check-label" htmlFor="emergency_refresh_F">Emergency</label>
                        </div>
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="refresh_F" radioGroup="SMST030_act_inact_F" name="Refresh_Type_F" checked={dataModel.Refresh_Type_F === 3} onChange={this.onRadioChangeF} value="r" />
                            <label className="form-check-label" htmlFor="refresh_F">Refresh</label>
                        </div>
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="noRefresh_F" radioGroup="SMST030_act_inact_F" name="Refresh_Type_F" checked={dataModel.Refresh_Type_F === 4} onChange={this.onRadioChangeF} value="nr" />
            ...
            <div className="col-md-12">
                <div className="mb-2">
                    ...
                    <div className="form-control border-0 ps-0">
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="act_inactA_F" radioGroup="SMST030_act_inact_F" name="IsActiveF" checked={dataModel.IsActiveF} onChange={this.onRadioChangeF} value="A" />
                            <label className="form-check-label" htmlFor="act_inactA_F">Active</label>
                        </div>
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="act_inactI_F" radioGroup="SMST030_act_inact_F" name="IsActiveF" checked={dataModel.IsActiveF === false} onChange={this.onRadioChangeF} value="I" />
