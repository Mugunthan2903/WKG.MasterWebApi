...
import SMST031VM from './SMST031VM';
import * as cntrl from '../../../wkl-components';

export default class SMST031 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST031VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
    ...
    renderForm() {
        ...
        return (<form>
                ...
                <div className="mb-2">
                    ...
                    <div className="form-control border-0 ps-0">
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="StatusA_F" radioGroup="SMST031_Status_F" name="IsActiveF" checked={dataModel.IsActiveF} onChange={this.onRadioChangeF} value="A" />
                            <label className="form-check-label" htmlFor="StatusA_F">Active</label>
                        </div>
                        <div className="form-check  form-check-inline" style={{ margin: "0 5px 0 5px" }}>
                            <input type="radio" className="form-check-input" id="StatusI_F" radioGroup="SMST031_Status_F" name="IsActiveF" checked={dataModel.IsActiveF === false} onChange={this.onRadioChangeF} value="I" />
            ...
            {model.Input.IsEdit && <><div className="col-md-12">
                <div className="mb-2">
                    <label className="form-label">LTD Type Available</label>
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox disabled={true} name="LTD_avail_F" value={dataModel.LTD_avail_F} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
                <div className="col-md-12">
                    <div className="mb-2">
                        ...
                        <div className='col-md-12'>
                            <cntrl.WKLTextbox disabled={true} name="Sort_ordr_F" value={dataModel.Sort_ordr_F} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                            </cntrl.WKLTextbox>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-2">
                                            <label className="form-label" >Event Name</label>
                                            <cntrl.WKLTextbox disabled={dataModel.IsEdit} mandatory={true} name="Event_name_S" allowClear={true} ref={(el) => this.onRefChange(el, 'Event_name_S')} value={dataModel.Event_name_S} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                                            </cntrl.WKLTextbox>
                                        </div>
                                    </div>
                                    <div className="col-md-4 mb-2">
                                        ...
                                        <div className="form-control border-0 ps-0">
                                            <div className="form-check  form-check-inline">
                                                <input type="radio" className="form-check-input" id="StatusA_S" radioGroup="SMST031_Status_S" name="IsActiveS" checked={dataModel.IsActiveS} onChange={this.onRadioChangeS} value="A" />
                                                <label className="form-check-label" htmlFor="StatusA_S">Active</label>
                                            </div>
                                            <div className="form-check  form-check-inline">
                                                <input type="radio" className="form-check-input" id="StatusI_S" radioGroup="SMST031_Status_S" name="IsActiveS" checked={dataModel.IsActiveS === false} onChange={this.onRadioChangeS} value="I" />
