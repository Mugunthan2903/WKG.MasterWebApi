...
import SMST051VM from './SMST051VM';
import * as cntrl from '../../../wkl-components';

export default class SMST051 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST051VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
                            ...
                            <div className="col-md-12">
                                <div className='row'>
                                    <div className="col-md-12  mb-3 px-2">
                                        <label className="col-form-label" htmlFor="SentenceCase">To do Name</label>
                                        <cntrl.WKLTextbox name="SentenceCase" value={model.SentenceCase} onChange={this.onChange} placeholder="To do Name" maxLength={20} inputType={cntrl.WKLTextboxTypes.sentenceCase} />
                                    </div>
                                    <div class="col-md-6 mb-3 px-2">
                                        <label className="col-form-label" htmlFor="ColorPicker">Background Color </label>
                                        <cntrl.WKLColorPicker name="ColorPicker" value="#0dcaf0" onChange={this.onChange} placeholder="select color" />
                                    </div>
                                    <div className="col-md-6  mb-3 px-2">
                                        <label className="col-form-label" htmlFor="SentenceCase">Gradient color</label>
                                        <cntrl.WKLColorPicker name="ColorPicker" value="#0dcaf0" onChange={this.onChange} placeholder="select color" />
                                    </div>
                                    <div className="col-md-6 mb-3 px-2" >
