...
import SMST053VM from './SMST053VM';
import * as cntrl from '../../../wkl-components';

export default class SMST053 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST053VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
                        ...
                        <div className="col-md-12">
                            <div className='row'>
                                ...
                                <div className="col-md-6  mb-3 px-2">
                                    ...
                                    <cntrl.WKLTextbox name="SentenceCase" value={model.SentenceCase} onChange={this.onChange} placeholder="Content Text" maxLength={20} inputType={cntrl.WKLTextboxTypes.sentenceCase} />
                                </div>
