...
import SMST005VM from './SMST005VM';
import * as cntrl from '../../../wkl-components';

export default class SMST005 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST005VM(props));
        this.inputRefs = {};
    }
    ...
    renderForm() {
        ...
        return (<form>
            <div className="mb-2">
                <label className="form-label" htmlFor="SMST001_txt_Text">Pos code<span className="text-danger text-mandatory">*</span></label>
                <div className='col-md-12'>
                    <cntrl.WKLSelect name="SMST005_Pos_code" disabled={dataModel.IsEdit} compareKey="ID" displayField="Text" placeholder="Select Pos code" allowClear={true} ref={(el) => this.onRefChange(el, 'SMST005_Pos_code')} selectedItem={dataModel.SMST005_Pos_code} dataSource={model.SMST005_Pos_code_list} onChange={this.onSearchChangeIn}>
                    </cntrl.WKLSelect>
                </div>
            </div>
            <div className="mb-2">
                ...
                <div className="form-control border-0 ps-0">
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="statusA_SMST005" radioGroup="status_SMST005" name="IsActive" checked={dataModel.IsActive == 'S'} onChange={this.onRadioChange} value="S" />
                        <label className="form-check-label" htmlFor="statusA_SMST005">Sandbox</label>
                    </div>
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="statusI_SMST005" radioGroup="status_SMST005" name="IsActive" checked={dataModel.IsActive == 'P'} onChange={this.onRadioChange} value="P" />
                        <label className="form-check-label" htmlFor="statusI_SMST005">Production</label>
                    </div>
                </div>
            </div>
                            ...
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-5 mb-2">
                                        ...
                                        <cntrl.WKLSelect name="Poscode" compareKey="ID" displayField="Text" placeholder="Select Pos code" allowClear={true} ref={(el) => this.onRefChange(el, 'Poscode')} selectedItem={dataModel.Poscode} dataSource={model.PoscodeList} onChange={this.onSearchChange}>
                                        </cntrl.WKLSelect>
                                    </div>
