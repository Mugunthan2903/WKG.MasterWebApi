...
import SMST002VM from './SMST002VM';
import * as cntrl from '../../../wkl-components';

export default class SMST002 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST002VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
    ...
    onBlurPrimary = (e) => {
        const model = this.VM.Data.Input
        if (this.VM && !model.IsEdit && model.SMST002_lang_code_form !== "") {
        ...
        return (<form>
            <div className="col-md-12">
                <div className="mb-2">
                    ...
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox disabled={dataModel.IsEdit} mandatory={true} name="SMST002_lang_code_form" allowClear={true} ref={(el) => this.onRefChange(el, 'SMST002_lang_code_form')} value={dataModel.SMST002_lang_code_form} onChange={this.onChange} events={{ onBlur: () => this.onBlurPrimary() }} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={10}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
                            ...
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-2">
                                            <label className="form-label" >
                                                Name</label>
                                            <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'languageName')} name="languageName" value={dataModel.languageName} onChange={this.onSearchChange} inputType={cntrl.WKLTextboxTypes.alphabets} maxLength={100}>
                                            </cntrl.WKLTextbox>
                                        </div>
                                    </div>
                                    <div className="col-md-4 mb-2">
                                        ...
                                        <div className="form-control border-0 ps-0">
                                            <div className="form-check  form-check-inline">
                                                <input type="radio" className="form-check-input" id="statusA_SMST002_S" radioGroup="status_SMST002_S" name="IsActiveS" checked={dataModel.IsActiveS} onChange={this.onRadioChangeS} value="A" />
                                                <label className="form-check-label" htmlFor="statusA_SMST002_S">Active</label>
                                            </div>
                                            <div className="form-check  form-check-inline">
                                                <input type="radio" className="form-check-input" id="statusI_SMST002_S" radioGroup="status_SMST002_S" name="IsActiveS" checked={dataModel.IsActiveS === false} onChange={this.onRadioChangeS} value="I" />
                                                <label className="form-check-label" htmlFor="statusI_SMST002_S">Inactive</label>
                                            </div>
                                        </div>
                                    </div>
