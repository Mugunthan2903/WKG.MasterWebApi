...
import SMST017VM from './SMST017VM';
import * as cntrl from '../../../wkl-components';


export default class SMST017 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SMST017VM(props));
        this.inputRefs = {};
    }
    ...
    onRadioChange = (e) => {
        if (this.VM) {
            let model = '';
            if (e.target.name === 'SMST017_StatusSrch') {
    ...
    renderForm() {
        ...
        return (<form>
            ...
            <div className="mb-2">
                <label className="form-label" htmlFor="SMST017_LangCode">Language<span className="text-danger text-mandatory">*</span></label>
                <div className='col-md-12'>
                    <cntrl.WKLSelect name="SMST017_LangCode" compareKey="ID" displayField="Text" placeholder="Select Language" allowClear={true} ref={(el) => this.onRefChange(el, 'SMST017_LangCode')} selectedItem={dataModel.SMST017_LangCode} dataSource={model.SMST017_LangCodeList} onChange={this.onChangeSelect}>
                    </cntrl.WKLSelect>
                </div>
            </div>
            <div className="mb-2">
                <label className="col-form-label" htmlFor="Name">Image Name<span className="text-danger text-mandatory">*</span></label>
                <cntrl.WKLFile isMultiFile={true} ref={(el) => this.onRefChange(el, 'SMST017_ImageName')} name="File" value={dataModel.SMST017_ImageName} onChange={this.onChange} placeholder="select File" />
            </div>
            {/* <div className="mb-2">
                <label className="form-label" >Image Name<span className="text-danger text-mandatory">*</span></label>
                <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'SMST017_ImageName')} name="SMST017_ImageName" value={dataModel.SMST017_ImageName} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={400}>
                </cntrl.WKLTextbox>
            </div> */}
            <div className="mb-2">
                <label className="form-label" htmlFor="SMST017_ImglinkTyp">Image Link Type</label>
                <div className='col-md-12'>
                    <cntrl.WKLSelect name="SMST017_ImglinkTyp" compareKey="ID" displayField="Text" placeholder="Select Image Type " allowClear={true} ref={(el) => this.onRefChange(el, 'SMST017_ImglinkTyp')} selectedItem={dataModel.SMST017_ImglinkTyp} dataSource={model.SMST017_ImglinkTypList} onChange={this.onChange}>
                    </cntrl.WKLSelect>
                </div>
            </div>
            <div className="mb-2">
                <label className="form-label" htmlFor="SMST017_ImglinkProd">Image Link Product</label>
                <div className='col-md-12'>
                    <cntrl.WKLSelect name="SMST017_ImglinkProd" compareKey="ID" displayField="Text" placeholder="Select Image product" allowClear={true} ref={(el) => this.onRefChange(el, 'SMST017_ImglinkProd')} selectedItem={dataModel.SMST017_ImglinkProd} dataSource={model.SMST017_ImglinkProdList} onChange={this.onChange}>
                    </cntrl.WKLSelect>
                </div>
            </div>
            <div className="mb-2">
                <label className="form-label" >Sort Order</label>
                <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'SMST017_SortOrder')} name="SMST017_SortOrder" value={dataModel.SMST017_SortOrder} onChange={this.onChange} prefix={5} suffix={0} inputType={cntrl.WKLTextboxTypes.numeric} numericType={cntrl.WKLNumericTypes.positive} maxLength={2}>
                </cntrl.WKLTextbox>
            </div>
            <div className="mb-3">
                ...
                <div className="form-control border-0 ps-0">
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="SMST017_StatusA" radioGroup="SMST017_Status" name="SMST017_Status" checked={dataModel.SMST017_Status} onChange={this.onRadioChange} value="A" />
                        <label className="form-check-label" htmlFor="SMST017_StatusA">Active</label>
                    </div>
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="SMST017_StatusI" radioGroup="SMST017_Status" name="SMST017_Status" checked={dataModel.SMST017_Status === false} onChange={this.onRadioChange} value="I" />
                        <label className="form-check-label" htmlFor="SMST017_StatusI">Inactive</label>
                    </div>
                </div>
            </div>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <div className="form-control border-0 ps-0">
                                                <div className="form-check  form-check-inline">
                                                    <input type="radio" className="form-check-input" id="SMST017_StatusSrchA" radioGroup="SMST017_StatusSrch" name="SMST017_StatusSrch" checked={dataModel.SMST017_StatusSrch} onChange={this.onRadioChange} value="A" />
                                                    <label className="form-check-label" htmlFor="SMST017_StatusSrchA">Active</label>
                                                </div>
                                                <div className="form-check  form-check-inline">
                                                    <input type="radio" className="form-check-input" id="SMST017_StatusSrchI" radioGroup="SMST017_StatusSrch" name="SMST017_StatusSrch" checked={dataModel.SMST017_StatusSrch === false} onChange={this.onRadioChange} value="I" />
                                                    <label className="form-check-label" htmlFor="SMST017_StatusSrchI">Inactive</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
