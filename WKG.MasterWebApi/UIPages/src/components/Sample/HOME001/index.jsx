...
import HOME001VM from './HOME001VM';
import * as cntrl from '../../../wkl-components';

export default class HOME001 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new HOME001VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
                                ...
                                <div className="col-md-5">
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-md-3">
                                            ...
                                            <div className="col-md-3">
                                                <input className="form-check-input ms-2" type="checkbox" name="IsSelected" checked={model.IsSelected} onChange={this.onCheckChange} style={{ width: "25px", height: "25px" }} />
                                            </div>
                                        </div>
                                ...
                                <div className='col-md-7 border-start'>
                                    <div className="row mb-3">
                                        <div className="col-md-4">
                                            <label className="col-form-label" htmlFor="SentenceCase">Name</label>
                                            <cntrl.WKLTextbox name="SentenceCase" value={model.SentenceCase} onChange={this.onChange} placeholder="Name" maxLength={20} inputType={cntrl.WKLTextboxTypes.sentenceCase} />
                                        </div>
                                    </div>
                                    <div className="row mb-3">
