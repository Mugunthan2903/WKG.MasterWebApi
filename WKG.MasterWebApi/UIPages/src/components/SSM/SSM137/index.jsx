...
import SSM137VM from './SSM137VM';
import * as cntrl from '../../../wkl-components';
import { fontSize } from '../../../wkl-components/WKLEditor/src/plugins';

export default class SSM137 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM137VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
                            ...
                            <div className="col-md-12">
                                <div className="row">
                                   ...
                                   <div className='col-md-2 mb-2'>
                                        <label className="form-label" htmlFor="Cntry_cd">Country</label>
                                        <cntrl.WKLSelect name="Cntry_cd" multiSelect={true} compareKey="ID" displayField="Text" placeholder="Select Country Name" allowClear={true} ref={(el) => this.onRefChange(el, 'Cntry_cd')} selectedItem={dataModel.Cntry_cd} dataSource={model.Cntry_cdList} onChange={this.onChange}>
                                        </cntrl.WKLSelect>
                                    </div>
                                    
                                    <div className="col-md-3 mb-2">
                                        <label className="form-label" >City/Area/Station</label>
                                        <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'LocationName')} name="LocationName" value={dataModel.LocationName} onChange={this.onSearchChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={100}>
                                        </cntrl.WKLTextbox>
                                    </div>
                                    ...
                                    <div className=" col-md-4 mb-2">
                                        ...
                                        <div className='d-flex'>
                                            <div className="col-md-2 mt-0">
                                                <input className="form-check-input" type="checkbox" name="City_Srch" checked={dataModel.City_Srch} onChange={this.onCheckChangeSrch} style={{ width: "20px", height: "20px" }} />
                                            </div>

                                            <div className="col-md-2 mt-0">
                                                <input className="form-check-input" type="checkbox" name="Area_Srch" checked={dataModel.Area_Srch} onChange={this.onCheckChangeSrch} style={{ width: "20px", height: "20px" }} />
                                            </div>


                                            <div className="col-md-2 mt-0">
                                                <input className="form-check-input" type="checkbox" name="Statn_Srch" checked={dataModel.Statn_Srch} onChange={this.onCheckChangeSrch} style={{ width: "20px", height: "20px" }} />
                                    ...
                                    <div className="col-md-1 mb-2">
                                        <label className="form-label" >Delisted</label>
                                        <div className="col-md-2 mt-2">
                                            <input className="form-check-input" type="checkbox" name="Delist_Srch" checked={dataModel.Delist_Srch} onChange={this.onCheckChangeSrch} style={{ width: "20px", height: "20px" }} />
                                        </div>

                                    </div>
                                    <div className="col-md-1">
                                        <div className="d-flex flex-row justify-content-end align-items-center h-100 w-100 p-2">
