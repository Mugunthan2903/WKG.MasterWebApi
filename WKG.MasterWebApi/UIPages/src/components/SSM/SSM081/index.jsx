...
import SSM081VM from './SSM081VM';
import * as cntrl from '../../../wkl-components';

class SSM081 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM081VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
                                                    ...
                                                    <div className='mb-1'>
                                                        ...
                                                        <div className="form-control border-0 ps-0">
                                                            <div className="form-check  form-check-inline">
                                                                ...
                                                                <label className="col-form-check-label" htmlFor="fee_type_P">Percentage</label>
                                                            </div>
                                                            <div className="form-check  form-check-inline">
                                                                <input type="radio" className="form-check-input mt-2" id="fee_type_F" radioGroup="fee_type" name="bkfee_type" checked={dataModel.bkfee_type === model.DefaultBookFeeType.Fixed} onChange={this.onRadioChange} value={model.DefaultBookFeeType.Fixed} />
