...
import SSM051VM from './SSM051VM';
import * as cntrl from '../../../wkl-components';

class SSM051 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM051VM(props));
                                        ...
                                        <div class="accordion-body p-2">
                                            <div className='row'>
                                                <div className="col-md-6">
                                                    <label className="col-form-label" >BG</label>
