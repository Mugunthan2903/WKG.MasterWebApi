...
import SSM110VM from './SSM110VM';
import * as cntrl from '../../../wkl-components';
import { Modal } from 'bootstrap';

export default class SSM110 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM110VM(props));
        this.inputRefs = {};
    ...
    onPageChange = (e) => {
        this.VM.onLoad(e.value, e.columnOptions);
    }
    onSortChange = (e) => {
        const gridInfo = this.VM.Data.GridInfo;
        this.VM.onLoad(gridInfo.Page, e.columnOptions);
    }
    onChangeLang = (e, item) => {
        const model = this.VM.Data;
        ...
        return (
            <form>
                ...
                <div className="col-md-8 mb-2">
                    <label className="col-form-label pt-0" htmlFor="NWTourctgrynam">Name&nbsp;<span className="text-danger text-mandatory">*</span></label>
                    <cntrl.WKLSelect name="NWTourctgrynam" compareKey="ID" displayField="Text" placeholder="Select Name" allowClear={false} ref={(el) => this.onRefChange(el, 'NWTourctgrynam')} selectedItem={dataModel.NWTourctgrynam} dataSource={model.NWTourctgrynam} onChange={this.onChange}>
                    </cntrl.WKLSelect>
                </div>
                                ...
                                <div className="col-md-7">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="mb-2">
                                                <label className="col-form-label pt-0" htmlFor="Tourctgrynam">Name</label>
                                                <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'Tourctgrynam')} name="Tourctgrynam" value={model.SearchInput.Tourctgrynam} onChange={this.onChangeSrch} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                                                </cntrl.WKLTextbox>
                                            </div>
                                        </div>
