...
import SSM023VM from './SSM023VM';
import * as cntrl from '../../../wkl-components';

export default class SSM023 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM023VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
            ...
            <div className="mb-2">
                ...
                <div className="form-control border-0 ps-0">
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_A" radioGroup="status_SSM023" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Percentage} onChange={this.onRadioChange} value={model.DefaultMarkupType.Percentage} />
                        <label className="form-check-label" htmlFor="mrkup_typ_A">Percentage</label>
                    </div>
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_I" radioGroup="status_SSM023" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Fixed} onChange={this.onRadioChange} value={model.DefaultMarkupType.Fixed} />
