...
export default class SSM105VM extends VMBase {
    constructor(props) {
        super(props);
    ...
    loadInitData() {
        ...
        this.updateUI();
        cntrl.Utils.ajax({ url: `${this._WebApi}/SSM105GetOnloadData`, data: dataInfo, files: [] }, (r) => {
            try {
                model.Loading = false;
    ...
    onBlurSrch() {
        ...
        this.updateUI();
        Utils.ajax({ url: `${this._WebApi}/SSM105OnBlurSearch`, data: dataInfo, files: [] }, (r) => {
            try {
                r = r || {};
    ...
    doSave(e) {
        if (this.isvalidSave(e)) {
            ...
            dataInfo.Savedata = model.Input.IsEdit === true ? "UPDATE" : "INSERT";
            model.Loading = true;
            me.updateUI();
            Utils.ajax({ url: `${this._WebApi}/SSM105SaveLangData`, data: dataInfo }, r => {
                try {
                    model.Loading = false;
                    r = r || {};
                    if (r.IsSuccess === true) {
