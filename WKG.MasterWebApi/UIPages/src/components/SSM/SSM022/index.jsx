...
import SSM022VM from './SSM022VM';
import * as cntrl from '../../../wkl-components';

export default class SSM022 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM022VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
    ...
    onCheckChange = (e) => {
        if (this.VM) {
            let model = '';
            if (e.target.name === "Status_Srch" || e.target.name === "Tui_Delist_Srch") {
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-md-2">
                                                <label className="col-form-label pt-0" htmlFor="Tui_Delist_Srch">Delisted</label>
                                                <div className="col-md-4 mt-1">
                                                    <input className="form-check-input ms-2" type="checkbox" name="Tui_Delist_Srch" checked={dataModel.Tui_Delist_Srch} onChange={this.onCheckChange} style={{ width: "20px", height: "20px" }} />
                                                </div>
                                            </div>
                                            <div className="col-md-2">
