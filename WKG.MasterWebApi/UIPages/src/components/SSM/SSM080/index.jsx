...
import SSM080VM from './SSM080VM';
import * as cntrl from '../../../wkl-components';
import { fontSize } from '../../../wkl-components/WKLEditor/src/plugins';

export default class SSM080 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM080VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
    ...
    clickAction = (e) => {
        if (this.VM) {
            if (e) {
                ...
                else if (action === 'btn_Info') {
                    this.VM.openWindow("Info", e.pid, e.pname);
                }
    ...
    onSortChange = (e) => {
        ...
        this.VM.handleSearch(gridInfo.Page, e.columnOptions, true);
    }

    onCheckChangeSrch = (e) => {
        if (this.VM) {
            let model = '';
            if (e.target.name === "StatusSrch" || e.target.name === "Adult_Aval_Srch") {
    ...
    columnbtn = (e) => {
        const pid = e.row.lp_prod_id;
        const pname = e.row.lp_prod_nam;
        return (<div>
                ...
                <div className="window-button-area">
                    <div className="row">
                        <div className="col-md-5">
                            <button type="button" id="btn_Info" hot-key="L" className="btn btn-sm btn-clear1 btn-primary me-1 col-auto" onClick={(e) => this.clickAction({ id: 'btn_Info' })}>Info</button>
                        </div>
