...
import SSM200VM from './SSM200VM';
import * as cntrl from '../../../wkl-components';

export default class SSM200 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM200VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
                                    ...
                                    <div className="col-md-5">
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-md-3">
                                                <label className="col-form-label pt-0" htmlFor="Pos_NameSrch">Pos Name</label>
                                                <cntrl.WKLSelect name="Pos_NameSrch" compareKey="ID" displayField="Text" placeholder="Select Pos Name" allowClear={true} ref={(el) => this.onRefChange(el, 'Pos_NameSrch')} selectedItem={model.SearchInput.Pos_NameSrch} dataSource={model.PosNameList} onChange={this.onChangeSrch}>
                                                </cntrl.WKLSelect>
                                            </div>
                                    ...
                                    <div className='col-md-7 border-start'>
                                        <div className="col-md-12 p-0">
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-4">
                                                    <label className="col-form-label pt-0" htmlFor="bkng_fee">Booking Fee</label>
                                                    <cntrl.WKLTextbox ref={(el) => this.onRefChange(el, 'bkng_fee')} name="bkng_fee" value={dataModel.bkng_fee} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.numeric} maxLength={10}>
                                                    </cntrl.WKLTextbox>
                                                </div>
                                            </div>
                                            <div className="row mb-3">
