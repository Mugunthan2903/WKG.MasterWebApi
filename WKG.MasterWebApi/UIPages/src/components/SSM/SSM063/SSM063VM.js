...
export default class SSM063VM extends VMBase {
    constructor(props) {
        super(props);
    ...
    loadInitData() {
        ...
        this.updateUI();
        cntrl.Utils.ajax({ url: `${this._WebApi}/SSM063OnloadData`, data: dataInfo, files: [] }, (r) => {
            try {
                model.Loading = false;
    ...
    onBlurSrch() {
        ...
        this.updateUI();
        Utils.ajax({ url: `${this._WebApi}/SSM063OnBlurSearch`, data: dataInfo, files: [] }, (r) => {
            try {
                r = r || {};
    ...
    doSave(e) {
        if (this.isvalidSave(e)) {
            ...
            model.Loading = true;
            me.updateUI();
            Utils.ajax({ url: `${this._WebApi}/SSM063SaveDataAsync`, data: dataInfo }, r => {
                try {
                    model.Loading = false;
                    r = r || {};
                    if (r.IsSuccess === true) {
