...
import SSM131VM from './SSM131VM';
import * as cntrl from '../../../wkl-components';

export default class SSM131 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM131VM(props));
    ...
    clickAction = (e) => {
        if (this.VM) {
            if (e) {
                ...
                else if (action == "sec2_lang_New") {
                    this.VM.openWindow("sec2_lang_New");
                }
    ...
    columnEditButton = (e) => {
        return (<span>
            <button type="button" style={{ width: "27px", height: "21px" }} name="sec2_lang_Edit" hot-key="H" title={"Edit"} data-bs-toggle="tooltip" data-bs-placement="left" className="btn btn-sm btn-icon1 btn-primary me-1" onClick={() => { this.onEditclick(e.row) }}><i className="fas fa-edit" style={{ fontSize: "10px", verticalAlign: "super" }}></i> </button>
        </span>)
    };
    renderGrid() {
                                        ...
                                        <div class="accordion-body p-2">
                                            <div className='row'>
                                                <div className="col-md-12">
                                                    ...
                                                    <cntrl.WKLTextbox name="Crrg_Name" disabled={true} value={dataModel.Crrg_Name} onChange={this.onChange} placeholder="Name" maxLength={100} inputType={cntrl.WKLTextboxTypes.sentenceCase} />
                                                </div>
                                                ...
                                                <div className='col-md-4 mt-2'>
                                                    <label className="form-label" htmlFor="Srvc_until">Service Until</label>
                                                    <cntrl.WKLTextbox name="Srvc_until" placeholder="HH:MM" value={dataModel.Srvc_until} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.time24hr} maxLength={5}></cntrl.WKLTextbox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className='row'>
                                                <div className="col-md-12 mb-3 px-3">
                                                    <div className='d-flex' style={{ justifyContent: "end", paddingTop: "10px" }}>
                                                        <button type="button" id="btn_add_new" hot-key="L" className="btn btn-sm btn-clear1 btn-primary me-1" onClick={(e) => this.clickAction({ id: 'sec2_lang_New' })}><i className="fa fa-add"></i> Add New</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='col-md-12'>
