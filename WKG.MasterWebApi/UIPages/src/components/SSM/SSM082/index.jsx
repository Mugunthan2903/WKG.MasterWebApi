...
import SSM082VM from './SSM082VM';
import * as cntrl from '../../../wkl-components';

export default class SSM082 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM082VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
    ...
    renderForm() {
        ...
        return (<form>
            ...
            <div className="mb-2">
                ...
                <div className="form-control border-0 ps-0">
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_A" radioGroup="status_SSM082" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Percentage} onChange={this.onRadioChange} value={model.DefaultMarkupType.Percentage} />
                        <label className="form-check-label" htmlFor="mrkup_typ_A">Percentage</label>
                    </div>
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_I" radioGroup="status_SSM082" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Fixed} onChange={this.onRadioChange} value= {model.DefaultMarkupType.Fixed}/>
            ...
            <div className="mb-2">
                ...
                <div className="col-md-4">
                    <input className="form-check-input ms-2" type="checkbox" id="statusI_SSM023" name="IsActive" checked={dataModel.IsActive} onChange={this.onCheckChange} style={{ width: "20px", height: "20px" }} />
                </div>
            </div>
