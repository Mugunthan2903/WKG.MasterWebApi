...
import SSM032VM from './SSM032VM';
import * as cntrl from '../../../wkl-components';

export default class SSM032 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM032VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
        ...
        return (<form>
            ...
            <div className="col-md-12">
                <div className="mb-2">
                    ...
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox disabled={true} name="delvry_price_F" value={dataModel.delvry_price_F} inputType={cntrl.WKLTextboxTypes.numeric} numericType={cntrl.WKLNumericTypes.positive} onChange={this.onChange} prefix={10} suffix={2} maxLength={12}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
            <div className="col-md-12">
                <div className="mb-2">
                    ...
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox name="WKG_mrkup_F" value={dataModel.WKG_mrkup_F} inputType={cntrl.WKLTextboxTypes.numeric} numericType={cntrl.WKLNumericTypes.positive} onChange={this.onChange} prefix={10} suffix={2} maxLength={12}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
