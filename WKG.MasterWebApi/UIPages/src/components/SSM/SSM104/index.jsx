...
import SSM104VM from './SSM104VM';
import * as cntrl from '../../../wkl-components';

export default class SSM104 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM104VM(props));
        this.inputRefs = {};
    }
    // called on load
    onLoad = () => {
    ...
    renderForm() {
        ...
        return (<form>
            ...
            <div className="mb-2">
                ...
                <div className="form-control border-0 ps-0">
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_A" radioGroup="status_SSM104" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Percentage} onChange={this.onRadioChange} value={model.DefaultMarkupType.Percentage} />
                        <label className="form-check-label" htmlFor="mrkup_typ_A">Percentage</label>
                    </div>
                    <div className="form-check  form-check-inline">
                        <input type="radio" className="form-check-input" id="mrkup_typ_I" radioGroup="status_SSM104" name="mrkup_typ" checked={dataModel.mrkup_typ === model.DefaultMarkupType.Fixed} onChange={this.onRadioChange} value= {model.DefaultMarkupType.Fixed} />
            ...
            <div className="mb-2">
                ...
                <div className="col-md-4">
                    <input className="form-check-input ms-2" type="checkbox" id="statusI_SSM104" name="IsActive" checked={dataModel.IsActive} onChange={this.onCheckChange} style={{ width: "20px", height: "20px" }} />
                </div>
            </div>
