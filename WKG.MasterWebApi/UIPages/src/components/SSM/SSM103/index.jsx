...
import SSM103VM from './SSM103VM';
import * as cntrl from '../../../wkl-components';

export default class SSM103 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM103VM(props));
    ...
    clickAction = (e) => {
        if (this.VM) {
            if (e) {
                ...
                else if (action === "btn_Addimg_bbs") {
                    this.VM.openWindow("btn_Addimg_bbs");
                }
                                        ...
                                        <div class="accordion-body p-2">
                                            <div className='row'>
                                                    ...
                                                    <div className='mb-1'>
                                                        ...
                                                        <div className="form-control border-0 ps-0">
                                                            <div className="form-check  form-check-inline">
                                                                <input type="radio" className="form-check-input" id="fee_type_P" radioGroup="fee_type" name="bkfee_type" checked={dataModel.bkfee_type === model.DefaultBookFeeType.Percentage} onChange={this.onRadioChange} value={model.DefaultBookFeeType.Percentage} />
                                                                <label className="form-check-label" htmlFor="fee_type_P">Percentage</label>
                                                            </div>
                                                            <div className="form-check  form-check-inline">
                                                                <input type="radio" className="form-check-input" id="fee_type_F" radioGroup="fee_type" name="bkfee_type" checked={dataModel.bkfee_type === model.DefaultBookFeeType.Fixed} onChange={this.onRadioChange} value={model.DefaultBookFeeType.Fixed} />
                                                ...
                                                <div className='col-md-5 mt-2'>
                                                    ...
                                                    <textarea name={"Cancl_policy"} style={{ resize: "none" }} ref={(el) => this.onRefChange(el, 'Cancl_policy')} value={dataModel.Cancl_policy} onChange={this.onChange} placeholder="Enter Cancellation Policy" className="form-control" rows="4" maxLength={500}></textarea>
                                                </div>
                                                <div className='col-md-2 mt-2'>
                                                    <label className="form-label" htmlFor="Cancl_refund">Cancel Refund</label>
                                                    <div className="col-md-3 mt-2">
                                                        <input className="form-check-input" type="checkbox" name="Cancl_refund" checked={dataModel.Cancl_refund} onChange={this.onCheckChange} style={{ width: "20px", height: "20px" }} />
                                                    </div>
                                                </div>
                                                <div className='col-md-5'>
                                                    <label className="col-form-label" >WKG Category</label>
                                                    <cntrl.WKLSelect name="WKG_Ctgry_ID" compareKey="ID" M displayField="Text" placeholder="Select WKG Category" allowClear={true} ref={(el) => this.onRefChange(el, 'WKG_Ctgry_ID')} multiSelect={true} selectedItem={dataModel.WKG_Ctgry_ID} dataSource={model.WKG_Ctgry_IDList} onChange={this.onChange}>
                                                    </cntrl.WKLSelect>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="col-md-6" >
                                                    ...
                                                    <div className="col-md-12 d-flex justify-content-between">
                                                        ...
                                                        <div className="col-md-2 px-2">
                                                            <button style={{ height: "33px" }} type="button" id="btn_Addimg_bbs" hot-key="L" className="btn btn-sm btn-primary me-1" onClick={(e) => this.clickAction({ id: 'btn_Addimg_bbs' })}><i className="fa fa-image"></i> </button>
                                                        </div>
                                                    </div>
