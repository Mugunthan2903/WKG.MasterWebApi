...
import SSM151VM from './SSM151VM';
import * as cntrl from '../../../wkl-components';

export default class SSM151 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM151VM(props));
                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-4 mb-2">
                                        ...
                                        <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'FareName')} name="FareName" value={dataModel.FareName} onChange={this.onSearchChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={100}>
                                        </cntrl.WKLTextbox>
                                    </div>
