...
export default class SSM053VM extends VMBase {
    constructor(props) {
        super(props);
    ...
    loadInitData() {
        ...
        this.updateUI();
        cntrl.Utils.ajax({ url: `${this._WebApi}/SSM053GetOnloadEditData`, data: dataInfo, files: [] }, (r) => {
            try {
                model.Loading = false;
    ...
    onBlurSrch() {
        ...
        this.updateUI();
        Utils.ajax({ url: `${this._WebApi}/SSM053OnBlurSearch`, data: dataInfo, files: [] }, (r) => {
            try {
                r = r || {};
    ...
    doSave(e) {
        if (this.isvalidSave(e)) {
            ...
            dataInfo.EXSavedata = model.Input.IsEdit === true ? "SOMWUPDATE" : "SOMWINSERT";
            model.Loading = true;
            me.updateUI();
            Utils.ajax({ url: `${this._WebApi}/SSM053SaveDataEdit`, data: dataInfo }, r => {
                try {
                    model.Loading = false;
                    r = r || {};
                    if (r.IsSuccess === true) {
