...
import SSM021VM from './SSM021VM';
import * as cntrl from '../../../wkl-components';

export default class SSM021 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM021VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
    ...
    onCheckChange = (e) => {
        if (this.VM) {
            let model = '';
            if (e.target.name === "Status_Srch" || e.target.name === "city_avail_Srch") {
        ...
        return (<form>
            <div className="row mb-3">
                <div className="col-md-12">
                    ...
                    <div className='col-md-12'>
                        <cntrl.WKLTextbox mandatory={true} disabled={true} name="City_Name" allowClear={true} ref={(el) => this.onRefChange(el, 'City_Name')} value={dataModel.City_Name} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={50}>
                        </cntrl.WKLTextbox>
                    </div>
                </div>
            </div>
            {/* <div className="row mb-3">
                <div className="col-md-12">
                    <label className="col-form-label" htmlFor="WKG_City">WKG City<span className="text-danger text-mandatory">*</span></label>
                    <cntrl.WKLSelect name="WKG_City" compareKey="ID" displayField="Text" placeholder="Select WKG City" allowClear={true} ref={(el) => this.onRefChange(el, 'WKG_City')} selectedItem={dataModel.WKG_City} dataSource={model.WKG_City_List} onChange={this.onChange}>
                    </cntrl.WKLSelect>
                </div>
            </div> */}
            <div className="row mb-3">
                <div className="col-md-12" >
                    <label className="col-form-label" htmlFor="WKG_City">WKG City<span className="text-danger text-mandatory">*</span></label>
                    <cntrl.WKLSelect minChar={3} multiSelect={false} name="WKG_City" placeholder="Select WKG City" ref={(el) => this.onRefChange(el, 'WKG_City')} allowClear={true} selectedItem={dataModel.WKG_City} onChange={this.onChange} asyncSearch={this.selectTourCitySearch} displayField="Text" compareKey="ID" />
                </div>
            </div>
    ...
    render() {
        ...
        return (
            <cntrl.WKLControl wrapperClass="modal-xl" loading={showloading} title={model.Title}
                                    ...
                                    <div className="col-md-12">
                                        <div className="row mb-3">
                                            <div className="col-md-6">
                                                ...
                                                <cntrl.WKLTextbox mandatory={true} name="ScrhcityName" allowClear={true} ref={(el) => this.onRefChange(el, 'ScrhcityName')} value={dataModel.ScrhcityName} onChange={this.onChangeSrch} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={100}>
                                                </cntrl.WKLTextbox>
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                <label className="col-form-label pt-0" htmlFor="city_avail_Srch">Delisted</label>
                                                <div className="col-md-4 mt-1">
                                                    <input className="form-check-input ms-2" type="checkbox" name="city_avail_Srch" checked={dataModel.city_avail_Srch} onChange={this.onCheckChange} style={{ width: "20px", height: "20px" }} />
                                                </div>
                                            </div>
                                            <div className="col-md-2">
