...
import SSM024VM from './SSM024VM';
import * as cntrl from '../../../wkl-components';

class SSM024 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM024VM(props));
    ...
    clickAction = (e) => {
        if (this.VM) {
            if (e) {
                ...
                else if (action === "btn_Addimg_tui") {
                    this.VM.openWindow("btn_Addimg_tui");
                }
                                        ...
                                        <div class="accordion-body p-2">
                                            <div className='row'>
                                                ...
                                                <div className='col-md-5'>
                                                    ...
                                                    <cntrl.WKLTextbox ref={(el) => this.onRefChange(el, 'Sort')} name="Sort" value={dataModel.Sort} onChange={this.onChange} inputType={cntrl.WKLTextboxTypes.numeric} numericType={cntrl.WKLNumericTypes.positive} prefix={4} suffix={0} >
                                                    </cntrl.WKLTextbox>
                                                </div>
                                                <div className='col-md-5'>
                                                    <label className="col-form-label" >Tui Category</label>
                                                    <cntrl.WKLSelect name="Tui_ctgry_ID" compareKey="ID" M displayField="Text" placeholder="Select Tui Category" allowClear={true} ref={(el) => this.onRefChange(el, 'Tui_ctgry_ID')} multiSelect={true} selectedItem={dataModel.Tui_ctgry_ID} dataSource={model.Tui_ctgry_IDList} onChange={this.onChange}>
                                                    </cntrl.WKLSelect>
                                                </div>
                                                <div className='col-md-2'>
                                        ...
                                        <div class="accordion-body p-2">
                                            <div className='row'>
                                                <div className="col-md-6">
                                                    <label className="col-form-label" >TUI</label>
                                                    ...
                                                    {/* </div> onChange={this.onChangeImg} */}
                                                </div>
                                                <div className="col-md-6" >
                                                    <label className="col-form-label" >WKL</label>
                                                    <div className="col-md-12 d-flex justify-content-between">
                                                        <div className="col-md-10">
                                                            <cntrl.WKLFile isMultiFile={false} accept='image/*' name="WKLImage_Upload" value={model.WKLImage_Upload} placeholder="Select Image" onChange={this.onChangeImg} />
                                                        </div>
                                                        <div className="col-md-2 px-2">
                                                            <button style={{ height: "33px" }} type="button" id="btn_Addimg_tui" hot-key="L" className="btn btn-sm btn-primary me-1" onClick={(e) => this.clickAction({ id: 'btn_Addimg_tui' })}><i className="fa fa-image"></i> </button>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12 border mt-1" style={{ height: "160px" }}>
                                                        {model.WKLImage_Url == "" ?
                                                            <img src="" style={{ height: "160px", width: "100%" }}></img> : <img src={model.WKLImage_Url} style={{ height: "160px", width: "100%" }}></img>
                                                        }
                                                    </div>
                                                </div>
                                            </div>
