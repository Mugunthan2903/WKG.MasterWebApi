...
import SSM150VM from './SSM150VM';
import * as cntrl from '../../../wkl-components';
import { fontSize } from '../../../wkl-components/WKLEditor/src/plugins';

export default class SSM150 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM150VM(props));
        this.inputRefs = {};
    }
    ...
    clickAction = (e) => {
        if (this.VM) {
            if (e) {
                ...
                else if (action === 'btn_Fare_dtls') {
                    this.VM.openWindow("Fare", e.pid, e.pname);
                }
            }
        }
    }
                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-4 mb-2">
                                        ...
                                        <cntrl.WKLTextbox mandatory={true} ref={(el) => this.onRefChange(el, 'DifferentialName')} name="DifferentialName" value={dataModel.DifferentialName} onChange={this.onSearchChange} inputType={cntrl.WKLTextboxTypes.sentenceCase} maxLength={100}>
                                        </cntrl.WKLTextbox>
                                    </div>
                ...
                <div className="window-button-area">
                    <div className="row">
                          <div className="col border-start">
                            <button type="button" id="btn_Fare_dtls" hot-key="C" className="btn btn-sm btn-close1 btn-primary me-1" onClick={(e) => this.clickAction({ id: 'btn_Fare_dtls' })}><i className="fa fa-image"></i> Fare </button>
                           </div>
