...
export default class SSM133VM extends VMBase {
    constructor(props) {
        super(props);
    ...
    init() {
        ...
        model.Input = {
            ...
            Props_Prod_Name: this.props.data.Crrg_Name,
            Crrg_Name: '',
            Language: null,
            ModifiedOn: null,
            ModifiedBy: "",
    ...
    newMode(flag = false) {
        ...
        dataModel.Props_Crrg_Name = this.props.data.Crrg_Name;
    ...
    loadInitData() {
        ...
        this.updateUI();
        cntrl.Utils.ajax({ url: `${this._WebApi}/SSM133GetOnloadData`, data: dataInfo, files: [] }, (r) => {
            try {
                model.Loading = false;
                ...
                if (model.Input.IsEdit) {
                    if (r.Nwrsltsec.length !== 0) {
                        ...
                        model.Input.Crrg_Name = info.prod_nam;
                        model.Input.Crrg_ID = info.prod_id;
                ...
                console.error("Error in SSM133 onload lang: ", ex);
            }
            finally {
                var dataCopyEx = this.getData();
                this.Data.DataCopy = JSON.stringify(dataCopyEx);
    ...
    onBlurSrch() {
        ...
        this.updateUI();
        Utils.ajax({ url: `${this._WebApi}/SSM133OnBlurSearch`, data: dataInfo, files: [] }, (r) => {
            try {
                r = r || {};
                ...
                console.error("Error in SSM133 blur search lang: ", ex);
            }
            finally {
                me.updateUI();
            }
    ...
    handleModified(data) {
        ...
        this.showConfirmation("Record already exists.Do you want to retrieve?", false, (e) => {
            if (e == 0) {
                ...
                model.Input.Crrg_ID = data.prod_id;
    ...
    handleSave(e) {
        ...
        if (this.isValueChanged()) {
            ...
            if (model.Input.IsEdit) {
                me.showAlert("No changes has been made.", 'Crrg_Name');
            }
            else {
    ...
    doSave(e) {
        if (this.isvalidSave(e)) {
            ...
            model.Loading = true;
            me.updateUI();
            Utils.ajax({ url: `${this._WebApi}/SSM133SaveLangData`, data: dataInfo }, r => {
                try {
                    model.Loading = false;
                    r = r || {};
                    if (r.IsSuccess === true) {
                    ...
                    console.error("Error in SSM133 save lang: ", ex);
                }
                finally {
                    me.updateUI();
                }
    ...
    setTitle() {
        ...
        if (model.Input.IsEdit) {
            model.Title = `${this.props.data.Crrg_Name} / Edit `;
        }
        else {
            model.Title = `${this.props.data.Crrg_Name} / New `;
        }
    }
    setFocus(name) {
