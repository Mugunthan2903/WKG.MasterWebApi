...
import SSM133VM from './SSM133VM';
import * as cntrl from '../../../wkl-components';

export default class SSM133 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM133VM(props));
        this.inputRefs = {};
                            ...
                            <div className="col-md-12">
                                <div className='row'>
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <cntrl.WKLTextbox name="Crrg_Name" value={dataModel.Crrg_Name} onChange={this.onChange} placeholder="Name" maxLength={800} inputType={cntrl.WKLTextboxTypes.sentenceCase} />
                                    </div>
