...
import SSM100VM from './SSM100VM';
import * as cntrl from '../../../wkl-components';

export default class SSM100 extends cntrl.WKLComponent {
    constructor(props) {
        super(props, new SSM100VM(props));
        this.inputRefs = {};
    }
    onLoad = () => {
        ...
        if (this.VM) {
            if (e) {
                ...
                if (action === "btn_search") {
                    ...
                    this.VM.openWindow("Exception", e.pid, e.pname, e.cityName);
                }
    ...
    columnbtn = (e) => {
        const pid = e.row.vntrt_prod_id;
        const pname = e.row.vntrt_prod_nam;
        const cityName = e.row.vntrt_city_nam;
        return (<div>
                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-2 mb-2">
                                        ...
                                        <cntrl.WKLSelect name="Supplier_Srch" compareKey="ID" displayField="Text" placeholder="Select Supplier" allowClear={false} ref={(el) => this.onRefChange(el, 'Supplier_Srch')} selectedItem={dataModel.Supplier_Srch} dataSource={model.Supplier_Srch_List} onChange={this.onSearchChange}>
                                        </cntrl.WKLSelect>
                                    </div>
                                    ...
                                    <div className="col-md-2 mb-2">
                                        ...
                                        <cntrl.WKLSelect name="City_srch" compareKey="ID" displayField="Text" placeholder="Select City Name" allowClear={true} ref={(el) => this.onRefChange(el, 'City_srch')} selectedItem={dataModel.City_srch} dataSource={model.City_srch_List} onChange={this.onSearchChange}>
                                        </cntrl.WKLSelect>
                                    </div>
                                    ...
                                    <div className="col-md-2 mb-2">
                                        ...
                                        <div className="col-md-2 mt-2">
                                            <input className="form-check-input" type="checkbox" name="Prd_aval" checked={dataModel.Prd_aval} onChange={this.onCheckChangeSrch} style={{ width: "20px", height: "20px" }} />
                                        </div>
                                    </div>
                ...
                <div className="window-button-area">
                    <div className="row">
                        <div className="col-md-5">
                            ...
                            {model.SearchInput.Supplier_Srch && model.SearchInput.Supplier_Srch.ID !== model.ToothBus ? (<button type="button" id="btn_open_windowcategory" hot-key="L" className="btn btn-sm btn-clear1 btn-primary me-1 col-auto" onClick={(e) => this.clickAction({ id: 'btn_open_windowCategory' })}>Filter Types</button>) : ""}
                        </div>
